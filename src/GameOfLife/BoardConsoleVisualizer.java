...
public class BoardConsoleVisualizer extends Board implements IBoardVisualizer {
	 ...
	 * @param areaSize Integer.
	 * @param timeSleep In miliseconds.
	 * @param displayCurrentCoordinates boolean
	 */
	public BoardConsoleVisualizer(int areaSize, int timeSleep, boolean displayCurrentCoordinates) {
		...
		if (timeSleep > 0)
			...
			throw new AppletIllegalArgumentException("timeSleep must be bigger then zero.");
